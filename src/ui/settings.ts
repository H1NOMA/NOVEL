...
export const QUALITY_PRESETS: Record<Quality, {
  ...
  low: { label: 'Низкое', pixelRatio: 1.0, stars: 1200, nebulae: false, bloomStrength: 0.0, planetOct: 5, samples: 0 },
  medium: { label: 'Среднее', pixelRatio: 1.5, stars: 2200, nebulae: true, bloomStrength: 0.14, planetOct: 7, samples: 2 },
  high: { label: 'Высокое', pixelRatio: 2.0, stars: 3200, nebulae: true, bloomStrength: 0.2, planetOct: 8, samples: 4 },
};
