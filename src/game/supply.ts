 ...
 *
 * Бездна закрывает мир для ЧУЖИХ, но не для хозяев. Раньше запрет «не трогать
 * миры в Бездне» стоял ещё и в стройке, верфях и бонусах — и погруженный мир
 * становился бесполезен самим иллюминатам: верфь на нём пропадала из списка,
 * щит поставить было нельзя. Теперь ограничение ровно одно и ровно здесь:
